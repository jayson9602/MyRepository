...
public class ShowUpdateFactoryServlet extends HttpServlet {

	@Override
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		String id = request.getParameter("id");
		FactoryManager factoryManager = new FactoryManagerImpl();
		Factory factory = factoryManager.findFactoryById(id);
		request.setAttribute("factory", factory);
		
		request.getRequestDispatcher("/basedata/factoryUpdate.jsp").forward(request, response);
	}
