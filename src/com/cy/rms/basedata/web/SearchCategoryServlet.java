...
public class SearchCategoryServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		PageModel pageModel = categoryManager.getCategorys(pageNo, pageSize, searchId, searchName);
		//将pageModel设置到Attribute中
		request.setAttribute("pageModel", pageModel);
		//转发到productList.jsp
		request.getRequestDispatcher("/basedata/categoryList.jsp").forward(request, response);
	}
